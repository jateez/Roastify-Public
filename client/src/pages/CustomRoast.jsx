      ...
      <div className="flex w-full min-h-screen flex-col items-center">
        <div className="w-full flex flex-col justify-start items-center p-10">
          ...
          <div className="flex gap-x-5 mt-5">
            <button className="btn btn-xs sm:btn-sm md:btn-md bg-spotify-green hover:bg-spotify-light-green text-spotify-off-white">All</button>
            <button className="btn btn-xs sm:btn-sm md:btn-md bg-spotify-green hover:bg-spotify-light-green text-spotify-off-white">Tracks</button>
            <button className="btn btn-xs sm:btn-sm md:btn-md bg-spotify-green hover:bg-spotify-light-green text-spotify-off-white">Artists</button>
          </div>
